module.exports.cm = function () {
	return `Hey, I’m FarmBot, the cutest bot ever! Here are the following commands I can do. **Type \`@FarmBot\` before any of these** to get my attention! **Words in bracket**s mean that they **need to be changed based on what you want to put there**.
[quote=General]
...
\`@FarmBot view level\` — view your experience level
[/quote]
[quote="Farming"]
...
\`@FarmBot bid reset\` — reset your bid
